...
def validate_token(token, command, max_time_delta=DEFAULT_MAX_TIME_DELTA):
  ...
  return validate_token_given_shared_secret(token, command, shared_secret, hostname, True, max_time_delta)
