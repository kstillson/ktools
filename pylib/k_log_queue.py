...
#
# You can use  k_log_queue.LEVELS.INFO  or even just  k_log_queue.INFO
# and get name for a number using k_log_queue.Levels.name(20)
...
def log(msg, level=LEVELS.INFO):
    ...
    LOG_QUEUE.insert(0, '%s: %s: %s' % (Levels.name(level), get_time(), msg))
