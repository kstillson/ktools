...
def test_get_initial_python_file_comment():
    assert C.get_initial_python_file_comment(__file__) == 'tests for common2.py'
    assert C.get_initial_python_file_comment() == 'tests for common2.py'
