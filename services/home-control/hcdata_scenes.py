...
SCENES = {
 ...
 # Activity-based
  ...
  'panic'       : [ 'all', 'sirens' ],
  'party'       : [  'PLUG-tp-bendy:on', 'tp-breakfast-nook:off', 'tp-dining-chandelier:dim:10', 'tp-family-room-left:dim:15', 
                     'tp-family-room-right:dim:15', 'tp-kitchen-pendants:dim:30', 'tp-kitchen:off', 'tp-lounge:dim:20', 
                     'tp-office:dim:20', 'tp-window-lights:dim:20', 'accent-party:on', 'tree:on', 'twinkle:on', 'lightning:on' ],
