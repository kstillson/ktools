...
STATE_RULES = [
  #     partition  state          transition -> action          params
    ...
    StateRule('*', 'alarm-triggered', 'enter', 'announce',     '#a,@chime3,%f alarm triggered. %Ttrig seconds to disarm'),
...
TRIGGER_RULES = [
  ...
  # Don't allow escaping a triggered alarm or panic by setting any new mode except 'disarm'
    TriggerRule('alarm-triggered', '*'      , '*',             'arm-home'        , 'announce'           , '#a,cannot arm home once alarm triggered'),
    TriggerRule('alarm-triggered', '*'      , '*',             'arm-auto'        , 'announce'           , '#a,cannot arm auto once alarm triggered'),
    TriggerRule('alarm-triggered', '*'      , '*',             'arm-auto-delay'  , 'announce'           , '#a,cannot arm auto once alarm triggered'),
    TriggerRule('alarm-triggered', '*'      , '*',             'arm-away'        , 'announce'           , '#a,cannot arm away once alarm triggered'),
    TriggerRule('alarm-triggered', '*'      , '*',             'arm-away'        , 'announce'           , '#a,cannot arm away once alarm triggered'),
    TriggerRule('alarm-triggered', '*'      , '*',             'test-mode'       , 'announce'           , '#a,cannot enter test mode once alarm triggered'),
    TriggerRule('alarm'          , '*'      , '*',             'arm-home'        , 'announce'           , '#a,cannot arm home once alarm activated'),
    TriggerRule('alarm'          , '*'      , '*',             'arm-auto'        , 'announce'           , '#a,cannot arm auto once alarm activated'),
    TriggerRule('alarm'          , '*'      , '*',             'arm-auto-delay'  , 'announce'           , '#a,cannot arm auto once alarm activated'),
    TriggerRule('alarm'          , '*'      , '*',             'arm-away'        , 'announce'           , '#a,cannot arm away once alarm activated'),
    TriggerRule('alarm'          , '*'      , '*',             'arm-away-delay'  , 'announce'           , '#a,cannot arm away once alarm activated'),
    TriggerRule('alarm'          , '*'      , '*',             'test-mode'       , 'announce'           , '#a,cannot enter test mode once alarm activated'),
    TriggerRule('panic'          , '*'      , '*',             'arm-home'        , 'announce'           , '#a,cannot arm home once panic triggered'),
    TriggerRule('panic'          , '*'      , '*',             'arm-auto'        , 'announce'           , '#a,cannot arm auto once panic triggered'),
    TriggerRule('panic'          , '*'      , '*',             'arm-auto-delay'  , 'announce'           , '#a,cannot arm auto once panic triggered'),
    TriggerRule('panic'          , '*'      , '*',             'arm-away'        , 'announce'           , '#a,cannot arm away once panic triggered'),
    TriggerRule('panic'          , '*'      , '*',             'arm-away-delay'  , 'announce'           , '#a,cannot arm away once panic triggered'),
    TriggerRule('panic'          , '*'      , '*',             'test-mode'       , 'announce'           , '#a,cannot enter test mode once panic triggered'),
