...
WHITELIST = [
    ...
    WL('fsdock',    '201001',      False, False, '/usr/lib/ssh/sftp-server'),
    WL('fsdock',    'dken',        False, False, '/usr/lib/ssh/sftp-server'),
    WL('fsdock',    'dken',        False, False, 'sshd: ken@notty'),
    WL('fsdock',    '201001',      False, False, 'sshd: pi2@notty'),
    ...
    WL('mysqldock', '200999',      False, False, 'mysqld'),
    WL('nagdock',   '200360',      True,  True,  '/usr/sbin/nagios'),
    WL('privdock',  '200100',      False, False, '/usr/sbin/httpd'),
    ...
    WL('webdock',   '200033',      False, False, '/bin/bash /usr/lib/cgi-bin/nagios-healthz.cgi'),
