...
WHITELIST = [
    ...
    WL('/',         'ken',         False, False, '(/bin/bash -c *)?(/usr/bin/retry -d [0-9]* -t 4 )?(/usr/bin/python3 )?/usr/local/bin/hc'),
    WL('/',         'ken',         False, False, '(/bin/bash -c *)?({ )?/usr/local/bin/sunsetter.py'),
    WL('/',         'ken',         False, False, '/usr/bin/python3 /usr/local/bin/sunsetter.py'),
